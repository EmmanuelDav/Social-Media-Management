...
public class Authentication extends AppCompatActivity {
    ...
    private MaterialButton fb_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LoginManager.getInstance().logInWithReadPermissions(Authentication.this, Arrays.asList("email", "public_profile"));
                LoginManager.getInstance().registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
                    @Override
                    public void onSuccess(LoginResult loginResult) {
                        Log.d(TAG, "facebook:onSuccess:" + loginResult);
                        handleFacebookAccessToken(loginResult.getAccessToken());
                        Toast.makeText(Authentication.this, "Facebook:Success", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancel() {
                        Log.d(TAG, "facebook:onCancel");
                        Toast.makeText(Authentication.this, "Facebook:Cancel", Toast.LENGTH_SHORT).show();
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast toast = Toast.makeText(Authentication.this, "USER: " + user.getDisplayName(), Toast.LENGTH_LONG);
                            toast.show();
                            updateUI();
                        } else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Log.d(TAG, "signInWithCredential:success");
                            FirebaseUser user = mAuth.getCurrentUser();
                            Toast.makeText(Authentication.this, "USER: " + user.getDisplayName(), Toast.LENGTH_LONG).show();
                        } else {
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            Toast.makeText(getApplicationContext(), "Authentication failed.",
                                    Toast.LENGTH_SHORT).show();
    ...
    private void updateUI() {
        Intent intent = new Intent(Authentication.this, fb_activity.class);
        startActivity(intent);
    }
